...
type LoadBalancerSettings_ConsistentHashLB_RingHash struct {
	...
	// single virtual node.
	MinimumRingSize uint32 `protobuf:"varint,1,opt,name=minimum_ring_size,json=minimumRingSize,proto3" json:"minimum_ring_size,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *LoadBalancerSettings_ConsistentHashLB_RingHash) GetMinimumRingSize() uint32 {
	if x != nil {
		return x.MinimumRingSize
	}
	return 0
...
type LoadBalancerSettings_ConsistentHashLB_MagLev struct {
	...
	TableSize     uint32 `protobuf:"varint,1,opt,name=table_size,json=tableSize,proto3" json:"table_size,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LoadBalancerSettings_ConsistentHashLB_MagLev) GetTableSize() uint32 {
	if x != nil {
		return x.TableSize
	}
	return 0
...
var file_networking_v1alpha3_destination_rule_proto_rawDesc = string([]byte{
	...
	0x72, 0x69, 0x6e, 0x67, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52,
	...
	0x62, 0x6c, 0x65, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09,
